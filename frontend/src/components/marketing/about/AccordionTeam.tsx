...
export default function AccordionTeam() {
  ...
  return (
    <section className="bg-[#1c1008] py-24 px-6 border-y border-stone-800">
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-12 items-center">
        ...
        <div className="flex-1 space-y-6">
          ...
          <h2 className="text-4xl md:text-5xl lg:text-5xl font-black text-white leading-tight tracking-tight">
            Kenali Orang-orang<br />di Balik <span className="text-primary">Wibi</span>
          </h2>
