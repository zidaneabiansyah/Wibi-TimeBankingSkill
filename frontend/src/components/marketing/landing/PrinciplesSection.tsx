...
export function PrinciplesSection() {
    return (
        <section className="py-24 md:py-32 relative border-t border-zinc-900 bg-[#0B0B0B] overflow-hidden">
            ...
            <div className="max-w-7xl mx-auto px-6 sm:px-12 relative z-10 font-sans">
                ...
                >
                    <h2 className="text-4xl md:text-[3.25rem] font-black tracking-tighter text-white leading-[0.9] mb-6">
                        Core<br />
                    ...
                    <div className="md:col-span-12 lg:col-span-4 flex flex-col gap-6">
                        ...
                        >
                            ...
                            <div className="relative z-10 h-full flex flex-col justify-between">
                                <span className="inline-block px-3 py-1 rounded-full border border-blue-500/20 bg-blue-500/10 text-blue-400 text-[10px] font-bold tracking-widest self-start mb-8 uppercase">
                                    Axiom II
                                </span>
                                <div>
                        ...
                        >
                            ...
                            <div className="relative z-10 h-full flex flex-col justify-between">
                                <span className="inline-block px-3 py-1 rounded-full border border-purple-500/20 bg-purple-500/10 text-purple-400 text-[10px] font-bold tracking-widest self-start mb-8 uppercase">
                                    Axiom III
                                </span>
                                <div>
