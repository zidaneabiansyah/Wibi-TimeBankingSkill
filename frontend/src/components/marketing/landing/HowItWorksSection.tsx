            ...
            <div className="mx-auto max-w-screen-xl px-4 sm:px-8 lg:px-12">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 sm:gap-6">
                    ...
                    >
                        ...
                        <div className="relative mt-auto w-full border-t border-border bg-card overflow-hidden flex items-end justify-center px-6 pt-10 min-h-[220px]">
                            <div className="w-full max-w-[320px] h-[180px] bg-background border border-border border-b-0 rounded-t-2xl shadow-[0_0_50px_rgba(0,0,0,0.5)] p-6 sm:p-8 transform group-hover:-translate-y-3 transition-transform duration-700 ease-[cubic-bezier(0.22,1,0.36,1)] flex flex-col justify-between relative z-10">
                                <div className="flex items-center gap-4">
                                    ...
                                    <div className="space-y-3 flex-1">
                                        ...
                                        <div className="h-2.5 bg-muted-foreground/10 rounded-full w-1/2" />
                                    </div>
                                </div>
                                <div className="flex gap-2">
                                    ...
                                    <div className="h-7 w-24 bg-background border border-border rounded-full" />
                                    <div className="h-7 w-16 bg-background border border-border rounded-full" />
                                </div>
                            </div>
                    ...
                    <div className="col-span-1 lg:col-span-7 flex flex-col gap-4 sm:gap-6">
                        ...
                        >
                            ...
                            <div className="w-full sm:w-[320px] lg:w-[360px] h-[220px] sm:h-auto border-t sm:border-t-0 sm:border-l border-border bg-card relative flex items-center justify-center p-6 lg:p-10 overflow-hidden">
                                <div className="w-full space-y-3 relative z-10 group-hover:scale-[1.03] transition-transform duration-700 ease-[cubic-bezier(0.22,1,0.36,1)]">
                                    ...
                                    <div className="flex justify-between items-center p-4 rounded-xl border border-border bg-background">
                                        <span className="text-xs text-muted-foreground font-mono tracking-wider">MAR 12 - 02:00 PM</span>
                                        <div className="w-4 h-4 rounded border border-border" />
                                    </div>
                                </div>
