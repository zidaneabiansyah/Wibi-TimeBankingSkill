                            ...
                            <div className="sticky top-24 space-y-6">
                                <Card className="bg-card/50 border-border/50 overflow-hidden">
                                    <CardHeader className="pb-3">
                                        <CardTitle className="text-lg">Similar Skills</CardTitle>
                                        <CardDescription>Explore related areas</CardDescription>
                                    </CardHeader>
                                    <CardContent className="space-y-4">
                                        {recommendations
                                            ...
                                            .slice(0, 4)
                                            .map((rec) => (
                                            <Link key={rec.id} href={`/marketplace/${rec.id}`} className="flex items-center gap-3 p-2 rounded-lg hover:bg-muted/50 transition-colors group">
                                                <div className="h-10 w-10 rounded-lg bg-primary/5 flex items-center justify-center text-xl group-hover:scale-110 transition-transform">
                                                    {rec.icon || '🎓'}
                                                </div>
                                                <div className="flex-1 min-w-0">
                                                ...
                                                <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-muted-foreground/50 group-hover:text-primary transition-colors">
                                                    <path d="m9 18 6-6-6-6" />
                                                </svg>
                                            </Link>
                                        ))}
                                ...
                                <Card className="bg-primary/5 border-primary/10 overflow-hidden">
                                    <CardContent className="p-6">
                                        ...
                                        <h3 className="font-semibold mb-1">Time Banking Safety</h3>
                                        <p className="text-xs text-muted-foreground">Credits are only transferred after both parties confirm the session completion.</p>
                                    </CardContent>
                                </Card>
                            </div>
                        </div>
