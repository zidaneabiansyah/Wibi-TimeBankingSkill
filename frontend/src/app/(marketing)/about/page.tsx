...
export const metadata: Metadata = {
  title: 'About Us - Our Mission & Values | Wibi',
  description: 'Learn about Wibi, the peer-to-peer skill exchange platform for students. Our mission is to make education accessible through time banking.',
  keywords: ['about wibi', 'our mission', 'student platform', 'time banking platform', 'peer learning'],
  openGraph: {
    title: 'About Wibi - Empowering Students',
    description: 'Making education accessible through skill exchange and time banking.',
    images: ['/wibi.png'],
  },
};
      ...
      <section className="w-full py-16 md:py-24 bg-background border-t border-border/40">
        <div className="mx-auto max-w-screen-2xl px-6 sm:px-12 lg:px-16">
          <div className="text-center mb-12">
            ...
            <p className="text-muted-foreground text-lg mt-4 max-w-150 mx-auto">
